...
class MenuTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.menuItems.append(MenuItemModel(title: "Keystage 1"))
        self.menuItems.append(MenuItemModel(title: "Keystage 2"))
        self.menuItems.append(MenuItemModel(title: "Keystage 3"))
    }
